...
public class ChangeFormTableRow implements FormTableRow {
    private String no;
    ...
    public ChangeFormTableRow() {
    }

    public ChangeFormTableRow(String no, String newOld, String systemID, String checkIn, String programFileName, String programExecutionName, String programDescription) {
        this.no = no;
        this.newOld = newOld;
